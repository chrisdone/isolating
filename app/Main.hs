...
postCreateGroupR = do
  ...
  case Forge.generate inputMap (Forge.verified createGroupForm) of
    _ -> undefined
        ...
        html_
          (do head_
                (do link_ [rel_ "shortcut icon", href_ "#"]
                    title_ "Self Isolating (COVID-19)"
                    link_
                                     ...
                                     (do p_
                                         ...
                                         p_
                                           (do label_ "Member Code: "
                                               input_
                                                 [type_ "text", name_ "code"])
                                         p_ (button_ "LOGIN")))
                             div_
                               [class_ "choice"]
                               (do h2_
                                     "Start a group for your street or block of apartments"
                                   p_
                                     "Before starting a group, please confirm that there is not \
                                      \already a group created for your street or apartment block."
                                   form_
                                     [action_ (url HomeR), method_ "POST"]
                                     (do relaxHtmlT (Forge.view (Forge.verified createGroupForm))
                                         p_ (button_ "GET CODE")))))
                    div_
                      [class_ "wrap"]
                      (do h3_ "Information"
                          ...
                          p_
                            (strong_
                               "Isolating.org is NOT a government-run web site.")
